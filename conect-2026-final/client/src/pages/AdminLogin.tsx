 ...
 * PÁGINA: Admin Login
 * 
 * Página de autenticação específica para administradores
 */
      ...
      <section className="py-20 md:py-32 bg-[#07090f]">
        <div className="container max-w-md mx-auto px-6">
          <div className="bg-[#131a2a] border border-[rgba(79,142,247,0.14)] rounded-lg p-8">
            <div className="flex items-center justify-center mb-6 p-4 bg-[rgba(79,142,247,0.1)] border border-[rgba(79,142,247,0.28)] rounded-lg">
              <Lock className="w-8 h-8 text-[#4f8ef7]" />
            </div>

            <h1 className="text-3xl font-black mb-2 text-center">Login Administrador</h1>
            <p className="text-[#8899bb] text-center mb-8">Acesso restrito ao painel administrativo</p>
            ...
            <div className="mt-8 p-6 bg-[rgba(79,142,247,0.05)] border border-[rgba(79,142,247,0.14)] rounded-lg">
              <p className="text-[#8899bb] text-sm mb-2 font-semibold">Credenciais de Teste:</p>
              <p className="text-[#8899bb] text-sm">
                Email: <strong>admin@conect.com</strong>
              </p>
              <p className="text-[#8899bb] text-sm">
