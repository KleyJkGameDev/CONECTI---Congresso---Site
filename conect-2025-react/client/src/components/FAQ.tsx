...
const faqItems: FAQItem[] = [
  {
    question: 'Qual é a data do CONECT 2025?',
    answer: 'O CONECT 2025 acontece de 14 a 16 de agosto de 2025 no câmpus Monte Castelo do IFMA em São Luís, Maranhão.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Você pode submeter artigos, TCCs ou projetos de extensão através da seção "Submissão" do site. O prazo é até 05/08/2025. A comissão científica avaliará e você receberá o resultado por e-mail em até 48h úteis.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Não há problema! As inscrições são abertas até 10/08/2025 ou enquanto houver vagas. Você pode chegar a qualquer momento durante o evento.',
  },
];
